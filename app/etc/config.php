...
return [
    'modules' => [
        ...
        'Amasty_RecurringPayments' => 1,
        'Amasty_RecurringStripe' => 1,
        'Klarna_KpGraphQl' => 1,
        'Klarna_Onsitemessaging' => 1,
        'Amasty_RecurringCashOnDelivery' => 1,
        ...
        'Tatva_Cart' => 1,
        'Tatva_Catalog' => 1,
        'Tatva_Catalog_Inventory' => 1,
        'Tatva_Categoryattribute' => 1,
        'Tatva_Categoryid' => 1,
        'Tatva_Categoryreport' => 1,
        'Tatva_Checkout' => 1,
        'Tatva_Contacts' => 1,
        'Tatva_Contract' => 1,
        'Tatva_Couponcode' => 1,
        'Tatva_CustomAttribute' => 1,
        'Tatva_Customdesignservice' => 1,
        'Tatva_Customdesignsubcategories' => 1,
        'Tatva_Loginpopup' => 1,
        'Tatva_Customerdashboard' => 1,
        'Tatva_Customerloginlog' => 1,
        'Tatva_Customerreport' => 1,
        'Tatva_Customproductreview' => 1,
        'Tatva_Customresumeservice' => 1,
        'Tatva_Deleteaccount' => 1,
        'Tatva_Downloadable' => 1,
        'Tatva_DownloadableImport' => 1,
        'Tatva_Downloaded' => 1,
        'Tatva_Downloadreport' => 1,
        'Tatva_Downloadscount' => 1,
        'Tatva_Ebook' => 1,
        'Tatva_EduTech' => 0,
        'Tatva_Emarsys' => 1,
        'Tatva_Formbuild' => 1,
        ...
        'Tatva_Free' => 1,
        'Tatva_Freesamples' => 1,
        'Tatva_Generalconfiguration' => 1,
        'Tatva_Gtm' => 1,
        'Tatva_KillSession' => 1,
        'Tatva_Limit' => 1,
        'Tatva_Subreminder' => 1,
        'Tatva_MediaStorage' => 1,
        'Tatva_Metadescription' => 1,
        'Tatva_Metatitle' => 1,
        'Tatva_NewProduct' => 1,
        'Tatva_Newsletter' => 1,
        'Tatva_Notification' => 1,
        'Tatva_OrderReport' => 0,
        'Tatva_PaidCustomerPopup' => 0,
        'Tatva_Paypalrec' => 1,
        'Tatva_Popup' => 1,
        'Tatva_Portfolio' => 1,
        'Tatva_ProductImport' => 1,
        'Tatva_Questionnaire' => 1,
        'Tatva_Quote' => 1,
        'Tatva_RecurringOrders' => 1,
        'Tatva_Removedefaultstore' => 1,
        'Tatva_Reports' => 1,
        'Tatva_Resume' => 1,
        'Tatva_SLIFeed' => 1,
        'Tatva_Sales' => 1,
        'Tatva_Schedualdemo' => 1,
        'Tatva_Sentence' => 1,
        'Tatva_Seositemap' => 1,
        'Tatva_Shareanddownloads' => 1,
        'Tatva_Sitemap' => 1,
        'Tatva_Stageoptions' => 1,
        'Tatva_Subscription' => 1,
        'Tatva_Customer' => 1,
        'Tatva_Supportingextensions' => 1,
        'Tatva_Tag' => 1,
        'Tatva_Tagtab' => 1,
        'Tco_Checkout' => 1,
        'Tatva_Testimonial' => 1,
        'Tatva_Theme' => 1,
        'Tatva_Translate' => 1,
        'Tatva_Translatedynamic' => 1,
        'Tatva_Ui' => 1,
        'Tatva_Unsubscribepaypal' => 1,
        'Tatva_Unsubscribetco' => 1,
        'Tatva_Unsubscribeuser' => 1,
        'Tatva_Visualsearch' => 1,
        'Tatva_Wishlist' => 1,
        'Tatva_ZohoCrm' => 1,
        'Tatva_TcoCheckout' => 1,
