...
require(['idangerous'], function($) {
	rotate_modified = -10;
      stretch_modified = 0 ;
      depth_modified = 150;
      modifier_modified = 1.0;
      screeen_width = jQuery( window ).width();
    

      if(screeen_width > 1919){
        rotate_modified = -10;
        stretch_modified = 90;
        depth_modified = 150;
        modifier_modified = 1.0;
      }
      else if(screeen_width > 1279){
        rotate_modified = -10;
        stretch_modified = 50;
        depth_modified = 160;
        modifier_modified = 1.0;
      ...
      else if(screeen_width > 1023){
        rotate_modified = -5;
        stretch_modified = -10;
        depth_modified = 40;
        modifier_modified = 1.0;
      }
      else if(screeen_width > 767){
        //alert(screeen_width);
        rotate_modified = -5;
        stretch_modified = -10;
        depth_modified = 40;
...
Swiper.prototype.plugins.tdFlow = function(swiper, params) {
	...
	var defaults = {
		...
		rotate : rotate_modified,
        stretch :stretch_modified,
        depth: depth_modified,
        modifier : modifier_modified,
        shadows : false,
	}
	params = params || {};
