var Swiper = function(selector, params) {
    ...
    _this.updateActiveSlide = function(position) {
        ...
        if (_this.support.classList) {
            ...
            jQuery("."+params.slider_active).removeClass(params.slider_active);
            _this.slides[(parseInt(_this.activeIndex)+1)].className += ' ' + params.slider_active;
            /*_this.slides[(parseInt(_this.activeIndex)+1)].className += ' ' + params.slider_active;*/
        }
        if (params.loop) {
    ...
    _this.updatePagination = function(position) {
        ...
        jQuery(".thumb_active").removeClass("thumb_active");
        var pagers = _this.paginationButtons;
        ...
        if (params.paginationAsRange) {
            ...
            if (params.loop) {
                if (pagers[_this.activeLoopIndex] !== undefined) {
                    ...
                    jQuery("#thumb_"+(parseInt(_this.activeLoopIndex)+1).toString()).addClass("thumb_active");
                    var testing = "#thumb_"+(parseInt(_this.activeLoopIndex)).toString();                   
                }
            } else {
                pagers[_this.activeIndex].className += ' ' + params.paginationActiveClass;
                jQuery("#thumb_"+(parseInt(_this.activeIndex)+1).toString()).addClass("thumb_active");
