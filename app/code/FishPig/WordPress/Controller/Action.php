...
abstract class Action extends ParentAction
{
  ...
  public function execute()
  {
  	...
  	if ( $controllerName == 'homepage' || $controllerName == 'post' ) {
	  	...
	  	if(isset($params['lang']))
	  	{
	  		...
	  		if(!empty($this->_cookieManager->getCookie('blog_language')))
	  		{
	  			$this->_cookieManager->deleteCookie('blog_language',$metadata);
	  		}
	  	}
	  }
  ...
  protected function _initLayout()
  {
    ...
    $this->getPage()->getConfig()->addBodyClass('is-blog');
		if ($breadcrumbsBlock = $this->_view->getLayout()->getBlock('wp.breadcrumbs')) {	    
