...
namespace Tatva\Paypalrec\Model\Paypal;
...
class Ipn extends \Magento\Paypal\Model\AbstractIpn implements \Magento\Paypal\Model\IpnInterface
{
    ...
    {        
        ...
        if(isset($data['payment_status']) && ($data['payment_status'] == "Refunded" || $data['payment_status'] == "Reversed" || $data['payment_status'] == "Canceled_Reversal"))
        {
            exit;
        }
    ...
    protected function _registerTransaction()
    {
        ...
        if($paymentStatus != Info::PAYMENTSTATUS_COMPLETED && $paymentStatus != Info::PAYMENTSTATUS_PROCESSED)
        {
            exit;        
        }
