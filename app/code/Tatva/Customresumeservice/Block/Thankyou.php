...
namespace Tatva\Customresumeservice\Block;
...
class Thankyou extends \Magento\Framework\View\Element\Template
{
    ...
    {   
        ...
        {
            if(strpos($this->_cookieManager->getCookie('previousPage'), 'business_research_services') !== false)
            {
                $block = $this->getLayout()->createBlock('Magento\Cms\Block\Block')->setBlockId('business-research-thank-you')->toHtml();
            } elseif (strpos($this->_cookieManager->getCookie('previousPage'), 'contacts') !== false) {
                $block = $this->getLayout()->createBlock('Magento\Cms\Block\Block')->setBlockId('contact-us-thank-you')->toHtml();
            } else {
                $block = $this->getLayout()->createBlock('Magento\Cms\Block\Block')->setBlockId('custom-thank-you')->toHtml();   
            }
            $array = array();
