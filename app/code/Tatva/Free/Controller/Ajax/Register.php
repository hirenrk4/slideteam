...
class Register extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        $captcha_data = $this->customerSession->getData('ebook_login_form_word')['data'];
        ...
        if($ebook_captcha['ebook_login_form'] != $captcha_data)
        {
            if($master_enable)
            {
        ...
        if($captcha_data != $ebook_captcha['ebook_login_form']){
            $response = [
                'errors' => true,
