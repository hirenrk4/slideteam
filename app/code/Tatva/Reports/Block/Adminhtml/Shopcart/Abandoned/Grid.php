<?php
namespace Tatva\Reports\Block\Adminhtml\Shopcart\Abandoned;
   ...
   /**
    ...
    protected function _prepareCollection()
    {
        ...
        if (!empty($data)) {
         ...
         $collection->getSelect()->columns(["customer_name"=>"CONCAT(customer_firstname,' ',customer_lastname)"]);
         $collection->getSelect()->columns(["email"=>"customer_email"]);
    ...
    public function getOptionDeletedArray()
    {
    ...
    protected function _prepareColumns()
    {
      $this->addColumn(
        ...
        $this->addColumn(
            'is_deleted',
            [
                'header' => __('Customer Deleted'),
                'index' => 'is_deleted',
                'type' => 'options',
                'filter'    => false,
                'options' => $this->getOptionDeletedArray()
            ]
        );
