...
// This is the directory where you put your CSV file.
    $path = $mediapath=$this->_filesystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath(). "metadescription_import";
    ;
    $files=$this->getRequest()->getFiles('Metadescription')['upload_file'];
    $fileId='Metadescription[upload_file]';
