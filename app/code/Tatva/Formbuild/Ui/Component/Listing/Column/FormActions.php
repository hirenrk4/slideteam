<?php
namespace Tatva\Formbuild\Ui\Component\Listing\Column;
        ...
        if(isset($dataSource['data']['items'])) {
            foreach($dataSource['data']['items'] as &$item)
            {
                $item[$this->getData('name')]['edit'] = [
                    'href' => $this->urlBuilder->getUrl('form/index/edit', ['id' => $item['form_id']]),
                    'label' => __('Edit'),
                    'hidden' => false
                ];
                $item[$this->getData('name')]['delete'] = [
                    'href' => $this->urlBuilder->getUrl('form/index/delete', ['id' => $item['form_id']]),
                    'label' => __('Delete'),
                    'hidden' => false
                ];
            }
