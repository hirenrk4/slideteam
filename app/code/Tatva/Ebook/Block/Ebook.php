...
class Ebook extends \Magento\Framework\View\Element\Template
{
    ...
    public function _prepareLayout()
    {
        ...
        $this->pageConfig->getTitle()->set(__('eBooks store'));
        return $this;
    }

    public function getEbookProductList()
    {
        $sort = "0";
        if (isset($_GET['sort'])) {
            $sort = $_GET['sort'];
