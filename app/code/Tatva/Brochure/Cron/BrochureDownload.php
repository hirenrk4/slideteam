...
class BrochureDownload
{
    ...
    public function execute()
    {
        ...
        $resumecategoryid = explode(',',$this->_scopeConfig->getValue('brochure/general/categoryName',\Magento\Store\Model\ScopeInterface::SCOPE_STORE));
        ...
        $filepath = 'specialproduct/brochuredownload_' . $filedate . '.csv';
        $file = 'brochuredownload_' . $filedate . '.csv';
        ...
        {
            $mail = new \Zend_Mail();
            $message = "Please find an attachment for the list of brochures downloaded.";
            ...
            $mail->setSubject('Brochures Download log');
            ...
            $to_email = explode(',',$this->_scopeConfig->getValue('brochure/general/to_email',\Magento\Store\Model\ScopeInterface::SCOPE_STORE));
            $cc_email = explode(',',$this->_scopeConfig->getValue('brochure/general/cc_email',\Magento\Store\Model\ScopeInterface::SCOPE_STORE));
