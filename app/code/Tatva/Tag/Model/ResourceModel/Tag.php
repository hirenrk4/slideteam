...
namespace Tatva\Tag\Model\ResourceModel;
...
class Tag extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    //         $searchTag = $this->dataObjectFactory->create();
    ...
    //     if ($this->frameworkNameBuilderHelper->strlen($object->getName()) > 255) {
    //         $object->setName($this->frameworkNameBuilderHelper->substr($object->getName(), 0, 255));
    //     }
    ...
    // {
    //     if (!$object->getStore() || !$this->storeManager->getStore()->isAdmin()) {
