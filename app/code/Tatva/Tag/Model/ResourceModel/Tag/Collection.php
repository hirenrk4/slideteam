...
namespace Tatva\Tag\Model\ResourceModel\Tag;
...
public function __construct(
     ...
     protected function _initSelect()
     {
        ...
        $this->addFilterToMap('tag_id', 'main_table.tag_id');
         ...
         ->from(
          ...
          joinLeft(
           ['tp'=>$this->getTable('tag_properties')],
           'main_table.tag_id = tp.tag_id',
           ['base_popularity'])->
         joinLeft(
           ['summary'=>$this->getTable('tag_summary')],
           'main_table.tag_id = summary.tag_id',
           ['store_id','popularity', 'customers', 'products'])->where('summary.store_id IN(?)', $storeId); 
    ...
    {
        $statusActive = \Tatva\Tag\Model\Tag\Relation::STATUS_ACTIVE;
