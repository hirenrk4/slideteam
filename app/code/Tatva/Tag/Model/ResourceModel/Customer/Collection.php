...
namespace Tatva\Tag\Model\ResourceModel\Customer;
...
class Collection extends \Magento\Customer\Model\ResourceModel\Customer\Collection
{
    ...
    public function addProductName()
    {
        ...
        $collection = $this->catalogResourceModelProductCollectionFactory->create()->addAttributeToSelect('name')
    ...
    public function addFieldToFilter($attribute, $condition = null)
    {
        if ($attribute == 'name') {
            ...
            $this->getSelect()->where($where, null, \Magento\Framework\Db\Select::TYPE_CONDITION);
            return $this;
        } else {
