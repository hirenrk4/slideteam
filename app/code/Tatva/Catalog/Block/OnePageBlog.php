...
class OnePageBlog extends Template
{
    ...
    {
        $blogId = $this->scopeConfig->getValue('resume/general/one_page_blog_id', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        if(!empty($blogId))
        {           
            $this->_postCollection = $this->_postfactory->create();
    ...
    {
        $html = $this->_listPost->renderBlogOnePost($post,"onepage");
        return $html;
    }
