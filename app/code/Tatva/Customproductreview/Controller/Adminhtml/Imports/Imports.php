...
// This is the directory where you put your CSV file.
    $path = $mediapath=$this->_filesystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath(). "product_review_import";
    ;
    $files=$this->getRequest()->getFiles('Customproductreview')['upload_file'];
    $fileId='Customproductreview[upload_file]';
